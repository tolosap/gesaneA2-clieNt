...
@Component({
  selector: 'app-categoriaprofesionalview1',
  templateUrl: '../../../../shared/aplicaciones/view.html',
  styleUrls: ['./categoriaprofesionalview1.component.css']
})
export class Categoriaprofesionalview1Component implements OnInit {
