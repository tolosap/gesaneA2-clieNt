...
@Component({
  selector: 'app-categoriaprofesionalremove1',
  templateUrl: '../../../../shared/aplicaciones/remove.html',
  styleUrls: ['./categoriaprofesionalremove1.component.css']
})
export class Categoriaprofesionalremove1Component implements OnInit {
