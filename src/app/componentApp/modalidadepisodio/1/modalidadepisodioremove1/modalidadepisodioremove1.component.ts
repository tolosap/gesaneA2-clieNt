...
@Component({
  selector: 'app-modalidadepisodioremove1',
  templateUrl: '../../../../shared/aplicaciones/remove.html',
  styleUrls: ['./modalidadepisodioremove1.component.css']
})
export class Modalidadepisodioremove1Component implements OnInit {
  ob = 'modalidadepisodio';
  op = 'remove';
  profile = 1;
  // ---
  id: number;
