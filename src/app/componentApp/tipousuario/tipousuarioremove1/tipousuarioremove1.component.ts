...
@Component({
  selector: 'app-tipousuarioremove1',
  templateUrl: './tipousuarioremove1.component.html',
  styleUrls: ['./tipousuarioremove1.component.css']
})
export class Tipousuarioremove1Component implements OnInit {
  ob = 'tipousuario';
  op = 'remove';
  profile = 1;
  // ---
