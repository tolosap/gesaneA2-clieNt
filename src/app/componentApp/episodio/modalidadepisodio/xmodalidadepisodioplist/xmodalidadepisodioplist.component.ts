...
@Component({
  selector: 'app-xmodalidadepisodioplist',
  templateUrl: '../../../../shared/aplicaciones/plist.html',
  styleUrls: ['./xmodalidadepisodioplist.component.css']
})
export class EpisodioxmodalidadepisodioplistComponent implements OnInit {
  ob = 'episodio';
  op = 'plistx';
  profile = this.sessionService.getSessionProfile();
  // ----
  xob = 'modalidadepisodio';
  xid: number;
  // ----
  url = this.ob +
    '/' +
