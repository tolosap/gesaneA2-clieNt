...
@Component({
  selector: 'app-xcircunstanciasaltanew',
  templateUrl: '../../../../shared/aplicaciones/newedit.html',
  styleUrls: ['./xcircunstanciasaltanew.component.css']
})
export class EpisodioxcircunstanciasaltanewComponent implements OnInit {
  ob = 'episodio';
  op = 'newx';
