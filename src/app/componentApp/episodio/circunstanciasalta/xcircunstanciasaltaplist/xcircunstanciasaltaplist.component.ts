...
@Component({
  selector: 'app-xcircunstanciasaltaplist',
  templateUrl: '../../../../shared/aplicaciones/plist.html',
  styleUrls: ['./xcircunstanciasaltaplist.component.css']
})
export class EpisodioxcircunstanciasaltaplistComponent implements OnInit {
  ob = 'episodio';
  op = 'plistx';
  profile = this.sessionService.getSessionProfile();
  // ----
  xob = 'circunstanciasalta';
  xid: number;
  // ----
  url = this.ob +
    '/' +
